...
+----------------------------------------+--------------+--------------+------------+------------------+
| Model 1 – Paper MINMAX (MinBreachPath) | XXXX.XX      | X.XX         | XX         | X                |
| Model 2 – Gurobi Callbacks             | XXXX.XX      | X.XX         | N/A        | X                |
| Model 3 – Iterative No-Callbacks       | XXXX.XX      | X.XX         | XX         | X                |
+----------------------------------------+--------------+--------------+------------+------------------+
```
...
| 3 | `model_no_callbacks.py` | **Iterative Benders** (port of `new_Gurobi_no_callbacks.py`). Python loop: solve outer → solve inner → add cut → repeat. |
